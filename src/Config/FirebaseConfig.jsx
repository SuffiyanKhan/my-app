...
import { getFirestore, doc, setDoc, deleteDoc, collection, query, where, getDocs,  addDoc  } from "firebase/firestore";
...
export {storage ,ref, uploadBytesResumable, getDownloadURL, createUserWithEmailAndPassword, auth, doc, setDoc, db, onAuthStateChanged, signInWithEmailAndPassword, sendEmailVerification, deleteDoc, deleteUser, collection, query, where, getDocs,  addDoc }