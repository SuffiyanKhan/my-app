...
import { collection, db, onSnapshot, onAuthStateChanged, auth, doc, getDoc,  query, orderBy, deleteDoc } from '../../Config/FirebaseConfig';
...
function ClassesShow() {
    ...
    const [collectionName ,  setCollectName] = useState('')
    ...
    const deleteClass = async (id) => {
        try {
            ...
            // Perform deletion
            await deleteDoc(doc(db, `class${collectionName}`, id));
            console.log(id);
                               ...
                               <div className="card-body">
                                 <div className="d-flex justify-content-between">
                                     ...
                                     <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li className="dropdown-item" style={{cursor : 'pointer'}} onClick={() => {deleteClass(item.id)}} >Delete</li>
                                     </ul>
                                 </div>
